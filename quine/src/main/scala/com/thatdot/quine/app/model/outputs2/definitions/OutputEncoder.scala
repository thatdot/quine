...
object OutputEncoder {
  ...
  final case class Protobuf(
    ...
    override def folderTo: DataFolderTo[Repr] = DataFolderTo.quineValueFolder

    private val toPb = new QuineValueToProtobuf(descriptor)
    override def bytes(value: Repr): Array[Byte] = value match {
