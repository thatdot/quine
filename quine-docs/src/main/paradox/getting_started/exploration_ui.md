...
![Quick Queries shown when right-clicking a node](quick_queries.png)
...
![Textual results](text_results.png)

----------------------

Node appearances, contextual queries, and default starting queries in the query bar can be customized by using the corresponding @ref:[API calls documented](../reference/rest_api.md) under the heading of "UI Styling".
...
![Synthetic Edges](synthetic_edge.png)
