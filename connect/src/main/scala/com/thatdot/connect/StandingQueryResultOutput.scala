...
import com.thatdot.connect.importers.util.AwsOps
import com.thatdot.connect.importers.util.AwsOps.AwsBuilderOps
import com.thatdot.connect.serialization.QuineValueToProtobuf
...
object StandingQueryResultOutput extends LazyLogging {
  ...
  // Invariant: these keys must be fixed to the names of the loggers in connect's application.conf
