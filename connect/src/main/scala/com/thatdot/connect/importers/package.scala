...
import com.thatdot.connect.importers.Kinesis.KinesisSourceDef
import com.thatdot.connect.importers.SQS.SqsStreamDef
import com.thatdot.connect.importers.serialization.ImportFormat
import com.thatdot.connect.importers.serialization.ImportFormat.RetriableIngestFailure
...
package object importers extends StrictLogging {
  ...
  ): IngestSrcType[ConnectIngestControl] =
    settings match {
      case KafkaIngest(
            format,
            topics,
